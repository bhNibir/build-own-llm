...
<ConceptAnim name="attention-flow" caption="Query প্রতিটি Key-এর সাথে match → weight = focus amount" />
...
<Playground id="part-07/self-attention" title="Self-Attention on 3 Words" />
