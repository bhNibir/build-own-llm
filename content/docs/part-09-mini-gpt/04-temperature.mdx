...
<StepReveal steps={[
  { emoji: "📊", title: "Raw logits", body: "Model-এর raw output score" },
  { emoji: "🌡️", title: "÷ T", body: "Softmax-এর আগে scale" },
  { emoji: "📈", title: "Softmax", body: "T কম → peaked; T বেশি → flat" },
  { emoji: "🎲", title: "Sample", body: "Adjusted distribution থেকে pick" }
]} />
