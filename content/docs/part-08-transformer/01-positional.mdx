...
<StepReveal steps={[
  ...
  { emoji: "🌊", title: "PE vector", body: "sin/cos অথবা learned lookup" },
  { emoji: "➕", title: "Add to embed", body: "token_emb + pos_emb" },
  { emoji: "📤", title: "Attention-এ পাঠাও", body: "এখন order বোঝে!" }
]} />
...
- Attention নিজে থেকে position জানে না — **manually** যোগ করতে হয়
- Sin/cos encoding = fixed wave pattern দিয়ে position encode
- GPT সাধারণত **learned positional Embedding** ব্যবহার করে
