...
- **Code editor** — browser-এ edit করো
- **▶ Run** — instant console output
- **Reset** — original code-এ ফিরে যাও
- **Live animation** — tokenizer, next-token, attention, train-loop
- **Diagram + math** — Mermaid flow ও KaTeX formula
