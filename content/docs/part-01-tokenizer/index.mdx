---
title: Part 1 — Tokenizer
description: Text কে number-এ convert করা — LLM-এর প্রথম ধাপ
---

# Part 1: Tokenizer + Vocabulary

এই Part-এ আমরা **কোনো AI বানাবো না**। শুধু data prepare করব — যেটা না বুঝলে পরের কিছুই পরিষ্কার হবে না।
...
<Cards>
  <Card title="Lesson 01: LLM কীভাবে কাজ করে" href="/docs/part-01-tokenizer/01-llm-kivabe-kaj-kore" />
</Cards>
