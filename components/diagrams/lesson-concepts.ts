...
export const LESSON_CONCEPTS: Record<string, ConceptConfig> = {
  ...
  'part-00-intro/03-roadmap': { name: 'llm-pipeline', caption: '১০টি module — Mini GPT পর্যন্ত' },
  'part-01-tokenizer/01-llm-kivabe-kaj-kore': {
    name: 'next-token',
    caption: 'Fruit dataset: P(apple | i like) = ৫০%',
  },
  'part-01-tokenizer/02-dataset': {
    name: 'llm-pipeline',
    caption: '১০টি fruit sentence → tokenizer → model',
  },
  ...
  'part-01-tokenizer/04-vocabulary': {
    name: 'llm-pipeline',
    caption: '১২টি unique word → Word→ID map',
  },
  'part-01-tokenizer/05-encoding': {
    name: 'llm-pipeline',
    caption: 'Word → ID mapping থেকে number array',
  },
  ...
  'part-02-bigram/05-sampling-vs-argmax': {
    name: 'softmax-bars',
    caption: 'Temperature bar-এর উচ্চতা বদলায়',
  },
  'part-03-math/01-scalar-vector': { name: 'llm-pipeline', caption: 'Vector = embedding-এর ভিত্তি' },
  'part-03-math/02-matrix': { name: 'llm-pipeline', caption: 'Matrix = weight storage' },
  'part-03-math/03-dot-product': { name: 'attention-flow', caption: 'Dot product = similarity score' },
  'part-03-math/04-matmul': { name: 'llm-pipeline', caption: 'Matmul → attention ও FFN-এ' },
  ...
  'part-04-autograd/02-value': { name: 'train-loop', caption: 'Value class gradient track করে' },
  'part-04-autograd/03-backprop': { name: 'train-loop', caption: 'Chain rule দিয়ে backward pass' },
  ...
  'part-05-neural-network/02-layer': { name: 'llm-pipeline', caption: 'Layer = neuron-এর matrix' },
  'part-05-neural-network/03-mlp': { name: 'llm-pipeline', caption: 'Layer stack → MLP' },
  'part-05-neural-network/04-xor': { name: 'train-loop', caption: 'XOR: epoch বাড়লে loss কমে' },
  ...
  'part-06-neural-lm/03-loss': { name: 'softmax-bars', caption: 'Cross-entropy = prediction error' },
  'part-06-neural-lm/04-train': { name: 'train-loop', caption: 'Fruit data-তে ২০০ epoch' },
  'part-06-neural-lm/05-generate': { name: 'next-token', caption: 'Trained LM থেকে sample' },
  'part-07-attention/01-why-attention': { name: 'attention-flow', caption: 'Long-range dependency' },
  ...
  'part-08-transformer/01-positional': { name: 'llm-pipeline', caption: 'Position encoding যোগ' },
  'part-08-transformer/02-layer-norm': { name: 'train-loop', caption: 'Activation normalize' },
  ...
  'part-09-mini-gpt/01-gpt-architecture': { name: 'llm-pipeline', caption: 'Nটি transformer block stack' },
  'part-09-mini-gpt/02-train': { name: 'train-loop', caption: 'Fruit corpus-এ training loop' },
  'part-09-mini-gpt/03-generate': { name: 'next-token', caption: 'Fruit sentence generate' },
  'part-09-mini-gpt/04-temperature': { name: 'softmax-bars', caption: 'Temperature bar চওড়া/সংকীর্ণ করে' },
  'part-09-mini-gpt/05-top-k': { name: 'softmax-bars', caption: 'Top-k কম prob token বাদ দেয়' },
  'part-10-bridge/01-reading-nanogpt': { name: 'llm-pipeline', caption: 'Course → nanoGPT code map' },
  'part-10-bridge/02-whats-next': { name: 'llm-pipeline', caption: 'Production LLM-এ scale' },
};
